-- CreateEnum
CREATE TYPE "AssetType" AS ENUM ('EQUITY', 'ETF', 'FUND', 'ADR', 'CRYPTO', 'DEFI', 'NFT', 'BOND', 'RATES', 'MACRO', 'INFLATION', 'EMPLOYMENT', 'GDP', 'GEOPOLITICS', 'POLITICS', 'REGULATION', 'TRADE', 'ENERGY', 'METALS', 'AGRICULTURE', 'TECH', 'HEALTHCARE', 'FINANCE', 'CONSUMER', 'INDUSTRIAL', 'OTHER');
...
-- CreateTable
CREATE TABLE "PreprocessedCache" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "PreprocessedCache_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "PreprocessedCache_filterHash_key" ON "PreprocessedCache"("filterHash");

-- CreateIndex
CREATE INDEX "PreprocessedCache_filterHash_idx" ON "PreprocessedCache"("filterHash");

-- CreateIndex
CREATE INDEX "PreprocessedCache_expiresAt_idx" ON "PreprocessedCache"("expiresAt");
